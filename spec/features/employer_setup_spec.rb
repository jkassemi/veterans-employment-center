...
feature 'employers edit their accounts' do
  ...
  scenario 'when an employer indicates a hiring commitment number, it appears on their commitments page', :js => true do
    visit edit_employer_path(@user.employer)
  ...
  scenario 'when an employer indicates a hiring commitment number AND date, both appear on their commitments page', :js => true do
    visit edit_employer_path(@user.employer)
    fill_in "employer_commit_to_hire", with: '500'
  ...
  scenario 'when an employer removes their hiring commitment number, it no longer appears on their commitments page', :js => true do
    visit edit_employer_path(@user.employer)
    fill_in "employer_commit_to_hire", with: '500'
    find('#click-button').click
    visit commitments_path
